    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        if (result) {
          ...
          conn.sendFile(m.chat, 'https://a.top4top.io/p_37802zcmd1.png', 'You_Win.jpg', caption, m)
        } else {
          caption += `*kalah!*, ${alasanKalah},-${betAmount} Money\n`
          caption += `Uang Anda saat ini: ${user.money}\n`
          conn.sendFile(m.chat, 'https://a.top4top.io/p_37802zcmd1.png', 'You_Lose.jpg', caption, m)
        }
