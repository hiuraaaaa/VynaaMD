...
async function _tiktok(link, m) {
    try {
        if (global.db.data.users[m.sender].limit > 0) {
            const response = await fetch(`https://api.vtech.biz.id/api/download/tiktok?url=${link}&apikey=${vtech}`);
...
async function _douyin(link, m) {
    try {
        if (global.db.data.users[m.sender].limit > 0) {
            let response = await fetch(`https://api.vtech.biz.id/api/download/douyin?url=${link}&apikey=${vtech}`);
            let data = await response.json();
            if (!data.result.video || data.result.video.length === 0) {
                response = await fetch(`https://api.vtech.biz.id/api/download/douyinslide?url=${link}&apikey=${vtech}`);
...
async function _instagram(link, m) {
    try {
        if (global.db.data.users[m.sender].limit > 0) {
            const response = await fetch(`https://api.vtech.biz.id/api/download/igdowloader?url=${link}&apikey=${vtech}`);
...
async function _facebook(link, m) {
    try {
        if (global.db.data.users[m.sender].limit > 0) {
            const response = await fetch(`https://api.vtech.biz.id/api/download/fbdown3?url=${link}&apikey=${vtech}`);
...
async function _youtube(link, m) {
    try {
        if (global.db.data.users[m.sender].limit > 0) {
            const response = await fetch(`https://api.vtech.biz.id/api/download/yt?url=${link}&apikey=${vtech}`);
...
async function _spotify(url, m) {
    try {
        if (global.db.data.users[m.sender].limit > 0) {
            const res = await fetch(`https://api.vtech.biz.id/api/download/spotify?url=${url}&apikey=${vtech}`);
...
async function _twitter(url, m) {
    try {
        if (global.db.data.users[m.sender].limit > 0) {
            const api = await fetch(`https://api.vtech.biz.id/api/download/twitter2?url=${url}&apikey=${vtech}`);
...
async function _threads(url, m) {
    try {
        if (global.db.data.users[m.sender].limit > 0) {
            const apiResponse = await fetch(`https://api.vtech.biz.id/api/download/threads?url=${url}&apikey=${vtech}`);
...
async function _capcut(url, m) {
    try {
        if (global.db.data.users[m.sender].limit > 0) {
            const response = await fetch(`https://api.vtech.biz.id/api/download/capcut?url=${url}&apikey=${vtech}`);
            const res = await response.json();
...
async function _snackvideo(url, m) {
    try {
        if (global.db.data.users[m.sender].limit > 0) {
            const api = await fetch(`https://api.vtech.biz.id/api/download/snackvideo?url=${url}&apikey=${vtech}`);
            const res = await api.json();
...
async function _pindl(link, m) {
    try {
        if (global.db.data.users[m.sender].limit > 0) {
            const api = await fetch(`https://api.vtech.biz.id/api/download/pinterest?url=${link}&apikey=${vtech}`);
            const res = await api.json();
...
async function _xiaohongshu(url, m) {
    try {
        if (global.db.data.users[m.sender].limit > 0) {
            let res = await axios.get(`https://api.vtech.biz.id/api/download/rednote?url=${url}&apikey=${vtech}`);
...
async function _soundcloud(url, m) {
    try {
        if (global.db.data.users[m.sender].limit > 0) {
            const res = await fetch(`https://api.vtech.biz.id/api/download/soundcloud?url=${url}&apikey=${vtech}`);
...
async function _cocofun(url, m) {
    try {
        if (global.db.data.users[m.sender].limit > 0) {
            const res = await fetch(`https://api.vtech.biz.id/api/download/cocofun?url=${encodeURIComponent(url)}&apikey=${vtech}`);
