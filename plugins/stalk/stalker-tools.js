...
let handler = async (m, {
  ...
  if (command == 'ffstalk') {
    ...
    m.reply(wait);
    try {
      let ff = await fetch(`https://api.vtech.biz.id/api/stalk/ff?id=${text}&apikey=${vtech}`).then(res => res.json());
  ...
  if (command == 'mlstalk') {
    ...
    try {
      let ml = await fetch(`https://api.vtech.biz.id/api/stalk/ml?id=${id}&server=${server}&apikey=${vtech}`).then(res => res.json());
  ...
  if (command == 'mlstalk2') {
    ...
    let [id, server] = text.split('|');
    try {
      let ml = await fetch(`https://api.vtech.biz.id/api/stalk/ml-v2?id=${id}&server=${server}&apikey=${vtech}`).then(res => res.json());
  ...
  if (command == 'supersusstalk') {
    ...
    m.reply(wait);
    try {
      let sus = await fetch(`https://api.vtech.biz.id/api/stalk/supersus?id=${text}&apikey=${vtech}`).then(res => res.json());
  ...
  if (command == 'npmstalk') {
    ...
    m.reply(wait);
    try {
      let npm = await fetch(`https://api.vtech.biz.id/api/stalk/npm?name=${text}&apikey=${vtech}`).then(res => res.json());
  ...
  if (command == 'repostalk') {
    if (!text) throw `Example : ${usedPrefix + command} VynaaMD`;
    m.reply(wait);
    try {
      let repo = await fetch(`https://api.vtech.biz.id/api/stalk/repo?repo=${text}&apikey=${vtech}`).then(res => res.json());
  ...
  if (command == 'genshinstalk' || command == 'stalkgenshin') {
    ...
    m.reply(wait);
    try {
      let genshin = await fetch(`https://api.vtech.biz.id/api/stalk/genshin?id=${text}&apikey=${vtech}`).then(res => res.json());
  ...
  if (command == 'hokstalk') {
    ...
    m.reply(wait);
    try {
      let { result } = await fetch(`https://api.vtech.biz.id/api/stalk/hok?id=${text}&apikey=${vtech}`).then(res => res.json());
  ...
  if (command == 'robloxstalk') {
    ...
    m.reply(wait);
    try {
      let roblox = await fetch(`https://api.vtech.biz.id/api/stalk/roblox?username=${text}&apikey=${vtech}`).then(res => res.json());
