...
module.exports = {
  ...
  async participantsUpdate({ id, participants, action }) {
        ...
        case 'invite_v4':
            if (chat.welcome) {
                ...
                for (let user of participants) {
                    ...
                    const defaultWelcome = `sᴇʟᴀᴍᴀᴛ ᴅᴀᴛᴀɴɢ — *@subject*\n\nʜᴀɪ @user, sᴇɴᴀɴɢ ᴋᴀᴍᴜ ʙᴇʀɢᴀʙᴜɴɢ!\n@desc\n> © ᴠʏɴᴀᴀᴍᴅ`
                    const defaultBye = `sᴇʟᴀᴍᴀᴛ ᴛɪɴɢɢᴀʟ — *@subject*\n\n@user ᴛᴇʟᴀʜ ᴍᴇɴɪɴɢɢᴀʟᴋᴀɴ ɢʀᴜᴘ.\n> © ᴠʏɴᴀᴀᴍᴅ`

                    text = (isAdd
                        ? (chat.sWelcome || this.welcome || conn.welcome || defaultWelcome)
                        : (chat.sBye || this.bye || conn.bye || defaultBye))
                        .replace(/@subject/g, groupMetadata.subject || 'grup ini')
                    ...
                    await this.sendMessage(id, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                title: isAdd ? 'sᴇʟᴀᴍᴀᴛ ᴅᴀᴛᴀɴɢ' : 'sᴇʟᴀᴍᴀᴛ ᴛɪɴɢɢᴀʟ',
                                body: global.wm || '© ᴠʏɴᴀᴀᴍᴅ',
                                thumbnailUrl: pp,
            ...
            break
        case 'promote':
            text = (chat.sPromote || this.spromote || conn.spromote || '@user ᴅɪᴊᴀᴅɪᴋᴀɴ *ᴀᴅᴍɪɴ*.')
            text = text.replace(/@user/g, '@' + (participants[0] || '').split('@')[0])
            if (chat.detect) this.sendMessage(id, { text, mentions: [participants[0]] })
            break
        case 'demote':
            text = (chat.sDemote || this.sdemote || conn.sdemote || '@user ᴅɪᴄᴀʙᴜᴛ ᴅᴀʀɪ *ᴀᴅᴍɪɴ*.')
            text = text.replace(/@user/g, '@' + (participants[0] || '').split('@')[0])
            if (chat.detect) this.sendMessage(id, { text, mentions: [participants[0]] })
            break
    }
    ...
    async delete({ remoteJid, fromMe, id, participant }) {
        ...
        await this.reply(msg.key.remoteJid, `@${participant.split('@')[0]} ᴍᴇɴɢʜᴀᴘᴜs ᴘᴇsᴀɴ.\n> ɴᴏɴᴀᴋᴛɪꜰᴋᴀɴ: *.enable delete*`.trim(), msg, {
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'ʀᴇᴀʟ ᴏᴡɴᴇʀ ᴏɴʟʏ.',
        owner: 'ᴏᴡɴᴇʀ ᴏɴʟʏ.',
        mods: 'ᴍᴏᴅᴇʀᴀᴛᴏʀ ᴏɴʟʏ.',
        rpg: 'ꜰɪᴛᴜʀ *ʀᴘɢ* ʙᴇʟᴜᴍ ᴀᴋᴛɪꜰ.\n> ᴋᴇᴛɪᴋ *.enable rpg* ᴜɴᴛᴜᴋ ᴀᴋᴛɪꜰᴋᴀɴ.',
        nsfw: 'ꜰɪᴛᴜʀ *ɴsꜰᴡ* ʙᴇʟᴜᴍ ᴀᴋᴛɪꜰ.\n> ᴋᴇᴛɪᴋ *.enable nsfw* ᴜɴᴛᴜᴋ ᴀᴋᴛɪꜰᴋᴀɴ.',
        premium: '*ᴘʀᴇᴍɪᴜᴍ* ᴏɴʟʏ.\n> ᴋᴇᴛɪᴋ *.shop* ᴜɴᴛᴜᴋ ɪɴꜰᴏ ᴜᴘɢʀᴀᴅᴇ.',
        group: 'ɢᴜɴᴀᴋᴀɴ ᴅɪ *ɢʀᴜᴘ* sᴀᴊᴀ.',
        private: 'ɢᴜɴᴀᴋᴀɴ ᴅɪ *ᴄʜᴀᴛ ᴘʀɪʙᴀᴅɪ* sᴀᴊᴀ.',
        admin: '*ᴀᴅᴍɪɴ* ᴏɴʟʏ.',
        botAdmin: 'ᴊᴀᴅɪᴋᴀɴ ʙᴏᴛ sᴇʙᴀɢᴀɪ *ᴀᴅᴍɪɴ* ᴛᴇʀʟᴇʙɪʜ ᴅᴀʜᴜʟᴜ.',
        unreg: 'ᴋᴀᴍᴜ ʙᴇʟᴜᴍ ᴛᴇʀᴅᴀꜰᴛᴀʀ.\n> ᴅᴀꜰᴛᴀʀ: *#daftar nama.umur*',
        restrict: 'ꜰɪᴛᴜʀ ɪɴɪ sᴇᴅᴀɴɢ ᴅɪɴᴏɴᴀᴋᴛɪꜰᴋᴀɴ.'
    }[type]
